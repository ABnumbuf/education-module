...
def click_bt_r_2():
    ...
    win_r_2 = Tk()
    win_r_2.title(
        "Computing discrete logarithm: Sylvester-Pohlig-Hellman Method")
    win_r_2.geometry("1250x400+50+50")
    win_r_2.minsize(1200, 400)
    win_r_2.config(bg=bg_main)
    ...
    def example():
        try:
            ...
            for i in dis.sylvester_pohlig_hellman_method_output(
    ...
    def task():
        try:
            ...
            x = dis.sylvester_pohlig_hellman_method(
    ...
    block1 = Frame(win_r_2, bg=bg_main)
    ...
    scrlt.insert(tk.INSERT, read_text("text_mod2_block2.txt"))
    scrlt.configure(state=tk.DISABLED)

    block2 = Frame(win_r_2, bg=bg_main)
